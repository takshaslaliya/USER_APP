...
sed -i -E 's/const (Text\(.*\))/\1/g' lib/user/screens/group_details_screen.dart
sed -i -E 's/const (Text\(.*\))/\1/g' lib/user/screens/tabs/add_friends_tab.dart
sed -i -E 's/const (Text\(.*\))/\1/g' lib/user/widgets/whatsapp_link_sheet.dart
